...
pacman::p_load(data.table, ggplot2, tidyverse, stats, skimr, gamlss, gamlssTools, gridExtra, grid)
set.seed(99999)
...
# dir_paths[[3]] <- list(
#   csv_dir = "data/cv_sample_A_dfs",
#   rds_dir = "cv_sample_A_train/global_vols_logPhenoTRUE_logAgeFALSE_pbmods",
#   csv_path = "totalFALSE_logPhenoTRUE_logAgeFALSE\\.csv$",
#   log_age=FALSE
# )
# dir_paths[[4]] <- list(
#   csv_dir = "data/cv_sample_B_dfs",
#   rds_dir = "cv_sample_B_train/global_vols_logPhenoTRUE_logAgeFALSE_pbmods",
#   csv_path = "totalFALSE_logPhenoTRUE_logAgeFALSE\\.csv$",
#   log_age=FALSE
# )
...
pdf("global_mods_logPheno_logAge.pdf", width = 8.5, height = 11)  # Open PDF device
