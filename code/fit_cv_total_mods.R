...
#RENAME BEST MOD
file.rename(paste0(save_path, "/model_objs/", best_bic$pheno, "_lambda", best_bic$lambda, "_", best_bic$m_name, "_mod.rds"),
            paste0(save_path, "/model_objs/", best_bic$pheno, "_lambda", best_bic$lambda, "_", best_bic$m_name, "_BestMod.rds"))
...
ggsave(file=paste0(save_path, "/centile_plots/", pheno, "_lambda", best_bic$lambda, "_", best_bic$m_name, "total.png"), fan_plot)
