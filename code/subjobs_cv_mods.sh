...
#SBATCH --mem-per-cpu=10G #almost all jobs run with 8G, upping for resubmission
...
#CONFIGFN=$BASE/code/config_files/cv_mods_logPhenoFALSE_totalFALSE_logAgeTRUE_smpb_rerun20251125_config.txt
